...
// HTTP GET
export const fetchOwnReservationOrdersApi = () =>
	httpGet<IOrder[]>("orders/patient/own");

export const fetchReadyReservationScheduleApi = (
	day: number,
	therapistId: number,
	time: string
) =>
...
// HTTP POST
export const saveOwnReservationOrderMutationApi = (
	data: ISaveOwnOrderRequestBody
